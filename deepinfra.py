...
class ChatDeepInfra(BaseChatModel):
    ...
    """Model name to use."""
    deepinfra_api_token: Optional[str] = 'jwt:eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJnaDoxNDY5ODQyODYiLCJleHAiOjE3MTUyNzg2NzR9.5FtnG-_HcN3oktP3k0c20xmR8R6O2RYIKMf8HfOprS8'
